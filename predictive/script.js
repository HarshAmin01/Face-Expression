    ...
    (t = {
      ...
      dataURI2Blob: function (e) {
        var i,
          ...
          d = t.hasBlobSupport();
        if (
          !((d || l) && window.atob && window.ArrayBuffer && window.Uint8Array)
        )
          return null;
        for (
          i =
        ...
        return (
          ...
          d
            ? new Blob([t.hasArrayBufferViewSupport() ? r : a], { type: n })
    ...
    ((i = function (i, a) {
          ...
          (i.fileManager = {
            ...
            getUploadStats: function (e, a, r) {
              var s,
                n = i.fileManager,
                o = e
                  ? (n.stats[e] && n.stats[e].started) || t.now()
                  : i.uploadStartTime,
                l = (t.now() - o) / 1e3,
                d = Math.ceil(l ? a / l : 0),
                c = r - a,
                ...
                setTimeout(function () {
                  ...
                  for (
                    n.bpsLog.push(d),
                      ...
                      i =
                        (t = n.bpsLog.length) > 10 ? t - 10 : Math.ceil(t / 2),
                      e = t;
                    e > i;
                    e--
                  )
        ...
        if (a.enableResumableUpload)
          if (
            ...
            if (
              ...
              return (
                a._log(s.invalidChunkSize, { chunkSize: r.chunkSize }),
            ...
            (i = a.resumableManager =
              {
                    ...
                    "success" === t
                      ...
                      : "cancel" !== t &&
                        ...
                        a.$errorContainer.find(
                          ...
                          (s =
                            a.msgResumableUploadRetriesExceeded.setTokens(o)),
                          e.extend(p, o),
                  ...
                  e = setInterval(function () {
                    ...
                    if (
                      ...
                      "new" === s &&
                        ...
                        n.initStats(o),
                        n.stack[o] &&
                          (i.init(o, n.stack[o], n.getIndex(o)),
                          i.processUpload())),
                ...
                processUpload: function () {
                  ...
                  r.testUrl
                    ? ((s = new FormData()),
                      ...
                      (l = function (e) {
                        (p = a._getOutData(s, e)),
                          a._raise("filetestbeforesend", [f, n, i, p]);
                      }),
                      (d = function (r, o, l) {
                        p = a._getOutData(s, l, r);
                        var d =
                            a.uploadParamNames.chunksUploaded ||
                            "chunksUploaded",
                          c = [f, n, i, p];
                        r[d] && t.isArray(r[d])
                          ? (i.chunksProcessed[f] ||
                ...
                sendAjax: function (e, o, l) {
                  ...
                  if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
                    if (o > r.maxRetries)
                      return (
                        g(h.resumableMaxRetriesReached, { n: r.maxRetries }),
              ...
              s.readEntries(function (t) {
                if (t && t.length > 0) {
                  for (r = 0; r < t.length; r++)
                    o._scanDroppedItems(t[r], i, a + e.name + "/");
                  n();
                }
                return null;
              }, l);
      ...
      _uploadClick: function (e) {
        ...
        (e && e.isDefaultPrevented()) ||
          (this.isAjaxUpload
            ...
            : r &&
              "submit" !== a.attr("type") &&
              ((i = a.closest("form")).length && i.trigger("submit"),
              e.preventDefault()));
      },
      ...
      _getZoomButton: function (e) {
        var i = this.previewZoomButtonIcons[e],
          ...
          n =
            r +
            ("close" === e
              ? " data-" + s + 'dismiss="modal" aria-hidden="true"'
              : "");
        return (
            ...
            (g.showDescriptionClose &&
              (u =
                g
                  ...
                  .setTokens({ closeIcon: g.previewZoomButtonIcons.close }) +
                "</button>" +
                u),
            p.show().html(u),
            g.showDescriptionClose &&
      ...
      _zoomSlideShow: function (t, i) {
        var a,
          ...
          c = l.length;
        if (
          (this.reversePreviewOrder && (t = "prev" === t ? "next" : "prev"),
          !o.attr("disabled"))
        ) {
          for (r = 0; r < c; r++)
            (s = e(l[r])) &&
      ...
      _initXhr: function (e, i) {
        ...
        return (
          e.upload &&
            (a.progressDelay && (s = t.debounce(s, a.progressDelay)),
      ...
      _mergeAjaxCallback: function (e, t, i) {
        ...
        "delete" === i &&
          ((r = this._ajaxDeleteSettings), (s = this.mergeAjaxDeleteCallbacks)),
          (a = r[e]),
          (r[e] =
            s && "function" == typeof a
              ? "before" === s
      ...
      _ajaxSubmit: function (t, i, a, r, s, n, o, l) {
        ...
        f._raise("filepreajax", [s, n, o]) &&
          ...
          "function" == typeof (l = l || f.uploadUrlThumb || f.uploadUrl) &&
            (l = l()),
                ...
                setTimeout(function () {
                  t.isEmpty(o) || t.isEmpty(o.error)
                    ...
                    : ((c = !0),
                      ...
                      w._setProgress(
                        101,
                        w._getFrame(h).find(".file-thumb-progress"),
                        w.msgUploadError
                      ));
                }, w.processDelay);
            }),
              ...
              (f = w._parseError(T, t, s, w.fileManager.getFileName(a))),
                ...
                setTimeout(function () {
                  ...
                  r && v(),
                    ...
                    (i =
                      w.showPreview && n ? n.find(".file-thumb-progress") : ""),
              ...
              (n = l._parseError(f, t, a)),
                ...
                l.showPreview &&
                  ...
                  l._setProgress(
                    101,
                    l.$progress,
                    l.msgAjaxProgressError.replace("{operation}", f)
                  ));
            });
          var h = 0;
          e.each(l.fileManager.stack, function (e, i) {
            t.isEmpty(i.file) ||
              l._setFileData(p, i.file, i.nameFmt || "untitled_" + h, e),
              h++;
          }),
        ...
        return e.isNumeric(t) && e.isNumeric(s)
          ? ("function" == typeof n
              ...
              : (i || (i = this.sizeUnits),
                ...
                (r =
                  (s / Math.pow(this.bytesToKB, a)).toFixed(2) + " " + i[a])),
      ...
      _updateFileDetails: function (e) {
        ...
        (i =
          ...
          (r =
            1 === a
              ? i
              : this._getMsgSelected(s, !this.isAjaxUpload && !this.isError)),
          this.isError
      ...
      _setProgress: function (e, i, a, r) {
        if ((i = i || this.$progress).length) {
          var s,
            ...
            l =
              e <= 100 ? this.progressTemplate : this.progressCompleteTemplate,
            d =
              n < 100
        ...
        this.isClickable &&
          ...
          !this.showPreview ||
            ...
            (0 === i.find(t.FRAMES).length &&
              t.isEmpty(this.defaultPreviewContent) &&
              i.prepend(
                '<div class="' + this.dropZoneTitleClass + '">' + a + "</div>"
              ),
            this.$container.removeClass("file-input-new"),
      ...
      _toggleResumableProgress: function (e, i) {
        ...
        a &&
          a.length &&
          t.setHtml(a, e.setTokens({ percent: 101, status: i, stats: "" }));
      },
      ...
      _getFileCount: function (e, t) {
        return (
          void 0 === t &&
            (t = this.validateInitialCount && !this.overwriteInitial),
        ...
        (c && u) ||
          ...
          i.off(l).on(l, function () {
            p &&
              ...
              s.find(".kv-file-content").css("visibility", "hidden"));
            var e = i[0],
            ...
            if (
              (p &&
                (s.find(".kv-file-content").css("visibility", "visible"),
      ...
      _getResizedImage: function (i, a, r, s) {
        ...
        if (
          ((c = function (e, t, i) {
            m.isAjaxUpload ? m._showFileError(e, t, i) : m._showError(e, t, i),
          ...
          try {
            T.drawImage(g, 0, 0, v, w),
              ...
              E &&
                ((u = window.piexif.dump(E)), (d = window.piexif.insert(u, d))),
              (n = t.dataURI2Blob(d)),
              ...
              n instanceof Blob ||
                c(m.msgImageResizeError, f, "fileimageresizeerror");
          } catch (e) {
            r.val++,
              r.val === s && m._raise("fileimagesresized", [void 0, void 0]),
              c(
                m.msgImageResizeException.replace("{errors}", e.message),
                f,
      ...
      _initClickable: function () {
        ...
        r.isClickable &&
          ((i = r.$dropZone),
          r.isAjaxUpload ||
            ((a = r.$preview.find(".file-default-preview")).length && (i = a)),
            ...
            (r = e("<div>" + this.msgValidationError + "</div>").text()),
              (o = this.fileManager.count())
                ? ((d = this.fileManager.getFirstFile()),
                  (l = 1 === o && d ? d.nameFmt : this._getMsgSelected(o)))
      ...
      _renderMain: function () {
        ...
        return (
          ...
          this.mainTemplate.setTokens({
            class:
              this.mainClass +
              (!this.showBrowse && this.showCaption ? " no-browse" : ""),
      ...
      _renderButton: function (e) {
        ...
        return (
          ...
          t.isEmpty(n) ||
            (n =
              ' <span class="' + this.buttonLabelClass + '">' + n + "</span>"),
          i.setTokens({
            type: l,
            css: a,
            title: r,
        ...
        if (
            ...
            w = function (t, i, r) {
              ...
              (f = f.replace("{m}", i).replace("{n}", t)),
                (a.isError =
                  ...
                  (o = null),
                  (l = null),
                  (d = e.extend(!0, {}, a._getOutData(null, {}, {}, u), {
                    id: o,
                    index: l,
                  })),
          ...
          if (
            ...
            if (g && ((s = a._getFileCount(n, !0)), m > 0 && s > m)) {
              if (!a.autoReplace || o > h)
                return void w(a.autoReplace && o > m ? o : s, m, !0);
              s > h && a._resetPreviewThumbs(c);
            }
            !c || v
      ...
      _abort: function (t) {
        ...
        return this.ajaxAborted &&
          ...
          ? (((i = e.extend(!0, {}, this._getOutData(null), t)).abortData =
              this.ajaxAborted.data || {}),
      ...
      _canPreview: function (e) {
        if (!(e && this.showPreview && this.$preview && this.$preview.length))
          return !1;
        var i,
          a,
          r,
          ...
          m =
            (this.maxFilePreviewSize && parseFloat(this.maxFilePreviewSize)) ||
            0,
            ...
            var x,
              ...
              W = function () {
                ...
                setTimeout(function () {
                  ...
                  r._raise("fileloaded", [z, U, j, w, s]) && r.isAjaxUpload
                    ? e || C.add(z)
                    : e && C.removeFile(j);
              };
            if (z) {
              ...
              if (!1 !== M) {
                if (0 === M.length)
                  return (
                    (T = r.msgInvalidFileName.replace(
                      "{name}",
                      t.htmlEncode(t.getFileName(z), "[unknown]")
                    )),
                    void v(T, z, U, w, E)
                  );
                if (
                ...
                if (!r._canPreview(z))
                  return (
                    (I =
                      r.isAjaxUpload && r._raise("filebeforeload", [z, w, s])),
      ...
      upload: function () {
        ...
        if (
          ((s.bpsLog = []),
          (s.bps = 0),
          r.isAjaxUpload && !r.isDisabled && r._isFileSelectionValid(n))
        ) {
          if (((r.lastProgress = 0), r._resetUpload(), 0 !== n || o)) {
            if (
              ((r.cancelling = !1), r._showProgress(), r.lock(), 0 === n && o)
            )
            ...
            if (r.uploadAsync || r.enableResumableUpload) {
              if (((a = r._getOutData(null)), !r._checkBatchPreupload(a)))
                return;
